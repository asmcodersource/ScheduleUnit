        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstSubjectRefId = table.Column<int>(type: "int", nullable: false),
                    FirstSubjectId = table.Column<int>(type: "int", nullable: false),
                    SecondSubjectRefId = table.Column<int>(type: "int", nullable: false),
                    SecondSubjectId = table.Column<int>(type: "int", nullable: false),
                    ClassRoomRefId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lesson_ClassRoom_ClassRoomRefId",
                        column: x => x.ClassRoomRefId,
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Lesson_Subject_FirstSubjectId",
                        column: x => x.FirstSubjectId,
                        principalTable: "Subject",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Lesson_Subject_SecondSubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lesson_ClassRoomRefId",
                table: "Lesson",
                column: "ClassRoomRefId");

            migrationBuilder.CreateIndex(
                name: "IX_Lesson_FirstSubjectId",
                table: "Lesson",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lesson_SecondSubjectId",
                table: "Lesson",
